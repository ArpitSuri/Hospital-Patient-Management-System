...
const PatientForm = ({ patient, fetchPatients, setEditing }) => {
    ...
    return (<div className="bg-white rounded-lg shadow-md border border-purple-100 p-6 mb-8 w-full max-w-2xl mx-auto">
        <h2 className="text-xl sm:text-2xl font-semibold text-purple-800 mb-4 text-center">
            {patient ? 'Edit Patient Details' : 'Register New Patient'}
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-3">
                <button
                    type="submit"
                    className="bg-purple-700 hover:bg-purple-600 text-white font-medium py-2 px-6 rounded-md transition-colors shadow-sm w-full sm:w-auto"
                >
                    {patient ? 'Update Patient' : 'Register Patient'}
                </button>
                ...
                <button
                    type="button"
                    onClick={handleCancel}
                    className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-6 rounded-md transition-colors border border-gray-300 w-full sm:w-auto"
                >
                    Cancel
                </button>
            </div>
